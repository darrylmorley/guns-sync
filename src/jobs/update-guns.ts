...
import type { GunTraderProduct } from "../types/types";

const updateDatabase = async (data: GunTraderProduct[]) => {
...
const updateGunsSecheduled = schedule("*/1 * * * *", async () => {
  log.info("Updating database");
...
export { updateGunsSecheduled, updateGuns };
